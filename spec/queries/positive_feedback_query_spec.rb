...
describe Queries::PositiveFeedbackQuery do
  ...
  Given(:query) { Queries::PositiveFeedbackQuery.new }
  ...
  context "Returns Presentations when Passed Presentations" do
    ...
    Given(:prez_query) { Queries::PositiveFeedbackQuery.new(Presentation.scoped) }
  ...
  context "Returns Conferences when Passed Confereneces" do
    ...
    Given(:conf_query) { Queries::PositiveFeedbackQuery.new(Conference.scoped) }
